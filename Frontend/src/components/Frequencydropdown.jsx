...
function Frequencydropdown() {
  ...
  return (
    <div>
      ...
      >
        <Menu.Items className="origin-center z-50 absolute right-0 mt-2 w-56 max-h-60 overflow-auto rounded-md shadow-lg bg-dropdown ring-1 ring-white ring-opacity-5 focus:outline-none ">
  <div className="py-1">
    <Menu.Item>
      {({ active }) => (
        <a
